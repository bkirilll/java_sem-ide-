...
public class Main {
    ...
    static void ex1() {
        ...
        list.add("Ivanov", 123456);
        list.add("Ivanov", 123455126);
        list.add("Petrov", 12345623);
        list.add("Ivanova", 132123456);
        list.add("Ivanov", 1234512126);
        System.out.println(list.getAllList());
        System.out.println(list.getByLastName("Ivanov"));
